...
```bash
curl -X POST https://your-domain.com/api/watermark/decode \
...
const response = await fetch('https://your-domain.com/api/watermark/decode', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer origid_xxxxxxxxxxxxxxxx',
  },
...
response = requests.post(
    'https://your-domain.com/api/watermark/decode',
    headers=headers,
    files=files
)
